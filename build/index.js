                        ...
                        switch (mediaItem['@type']) {
                            case "ExistingImage":
                                return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("figure", {
                                    ...
                                    alt: mediaItem.hasOwnProperty("articleMetadata") && mediaItem.articleMetadata.hasOwnProperty("titleName") ? mediaItem.articleMetadata.titleName : "",
                                    width: mediaItem.width,
                                    height: mediaItem.height
                                }));

                            case "Video":
                                return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__["PlainText"], {
                                    tagName: "div",
                                    style: {
                                        height: 100,
                                        fontSize: 14,
                                    ...
                                    value: '[imigino_video url="' + mediaItem.url + '" title="' + mediaItem.usage.Headline + '"]'
                                });
                        ...
                        switch (mediaItem['@type']) {
                            case "ExistingImage":
                                return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("figure", {
                                    ...
                                    src: mediaItem.imageURL,
                                    alt: mediaItem.articleMetadata.titleName
                                }));
